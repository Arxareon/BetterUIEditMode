# <img src="https://wago-addons.ams3.digitaloceanspaces.com/thumbnails/FWxJtQUjJe24aWsbIwEUeN4ga6hHKkmB5UUci5AW.png" alt="Better UI Edit Mode Logo" width="40" height="40" align="top"> Better UI Edit Mode
...
Alongside the one-time & monthly donation options featured above, watching ads on [**CurseForge**]() or [**Wago**]() also supports my work. You can keep up to date via the CurseForge or Wago App *as well as **[WoWUP](https://wowup.io/)** if you enable CurseForge or Wago.io as an addon provider*.
